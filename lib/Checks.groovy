...
class Checks {
    ...
    // Print a warning if both params.db and params.download_genomes have been specified
    static void download_genomes_db_warn(log) {
        log.warn "=============================================================================\n" +
                 "  Both '--download_genomes' and '--db' parameters have been provided.\n" +
                 "  Specify either db or download_genomes.\n" +
                 "==================================================================================="
    }

    // Print a warning if both params.download_genomes
    static void download_genomes_warn(log) {
        log.warn "=============================================================================\n" +
                 " Parameter '--download_genomes' has been supplied.\n" +
                 " This can be a big (several gigabytes) download.\n" +
                 " Please be patient and use a fast connection.\n" +
                 "==================================================================================="
    }
}